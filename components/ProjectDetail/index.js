...
import imgTwo from '../../public/projectDetailTwo.png'
import imgOne from '../../public/projectDetail.png'
    ...
    return (    
        <>
            ...
            <div className={cls.logoTitle}>
                ...
                <IconAbout />
                <p className={cls.descriptionOnes}>Щелковский автовокзал</p>
            </div>
            ...
            <div className={cls.shchelkovskybusStation}>
                <div >
                    ...
                    <div className={cls.containerImg}>
                        <Image src={imgOne} alt="Picture of the author" />
                    </div>
